...
public class Adapter_for_photo extends RecyclerView.Adapter<Adapter_for_photo.ViewHolder> {

    Integer str1[]={R.drawable.mone,R.drawable.mtwo,R.drawable.mthree,R.drawable.mfour,R.drawable.mfive,R.drawable.msix,
            R.drawable.mseven,R.drawable.meight,R.drawable.mnine,R.drawable.mten};
    ...
    public Adapter_for_photo(Context context) {
